...
export class StandardTransactionsController {
  ...
  create(@Body() createTransactionDto: CreateTransactionDto) {
    return this.standardTransactionsService.create(createTransactionDto);
  }
  ...
  findAll(@Query() query: StandardTransactionQueryListDto) {
    return this.standardTransactionsService.findAll(
      query,
  ...
  findOne(@Param('id', ParseIntPipe) id: number) {
    return this.standardTransactionsService.findOne(id);
  }
  ...
  update(
    ...
    return this.standardTransactionsService.update(id, updateTransactionDto);
  }
  ...
  remove(@Param('id', ParseIntPipe) id: number) {
    return this.standardTransactionsService.remove(id);
  }
